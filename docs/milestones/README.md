...
| SC-M05 | Professional Widget Experience | [sc-m05-professional-widget-experience.md](sc-m05-professional-widget-experience.md) | Closed (PASS WITH LIMITATIONS) — [closure](../closure/sc-m05-professional-widget-experience-closure.md); merged `ceb5284`, not deployed; post-merge human AT (VoiceOver/NVDA) validation recommended | SC-M02 | R2, R3 |
