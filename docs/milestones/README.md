...
| SC-M07 | AI-First Visitor Support | [sc-m07-ai-first-visitor-support.md](sc-m07-ai-first-visitor-support.md) | Closed (PASS WITH LIMITATIONS) — [closure](../closure/sc-m07-ai-first-visitor-support-closure.md); merged `a81390086e37af04eba0a0ee1874949376be2c5a` (PR #59; freeze `537d3b0` / PR #57, PO acceptance `b47ce61` / PR #58; ADR-0018 Accepted). All CI green (unit 8.1/8.3/8.4, integration WP 6.9/7.1, interop ×2, docs). `db_version` `12 → 13`; version `0.8.0 → 0.9.0`. Limitations: real-provider verification, SC-M05-standard browser QA, VoiceOver/NVDA smoke, and functional DEV acceptance + PO functional sign-off — all deferred to DEV acceptance ([plan](../closure/sc-m07-dev-acceptance-plan.md)). Not deployed; production untouched | SC-M02; SC-M06 / ADR-0017 | R1, R4, R6 |
