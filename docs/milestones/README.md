...
| SC-M06 | Support Availability and Offline Tickets | [sc-m06-support-availability-and-offline-tickets.md](sc-m06-support-availability-and-offline-tickets.md) | Closed (PASS WITH LIMITATIONS) — [closure](../closure/sc-m06-support-availability-and-offline-tickets-closure.md); merged `f3b327b` (PR #53; freeze `cdfcd5a` / PR #51, PO acceptance `e7518bb` / PR #52; ADR-0017 Accepted). Not deployed. Accepted limitations: SC-M05-standard browser QA and a VoiceOver/NVDA offline-widget smoke, both recommended post-merge. DEV deployment & PO acceptance still outstanding | SC-M02; soft SC-M04 | R5, R7 |
