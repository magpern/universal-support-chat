...
- **DEV rehearsal runbook v2** supersedes v1: primary
  ...
  Pins the current `origin/main` heads universal-telegram `33b042ff98a3d78e9d6b2ac1c9eb6aa78bfb23b7` /
  universal-support-chat `2000eaf88fd223025e323d249496f7944a2db3e9` — `src/`+`tests/` identical
  to the F1 correction (`7d4cc4f` / `9144cb1`), only `docs/` added between the F1 closure commits
  (`32f17ea` / `5d81b5b`) and these heads. It revises only the
