...
| ~~[sc-m05-professional-widget-experience-plan-v1.md](sc-m05-professional-widget-experience-plan-v1.md)~~ (superseded) | SC-M05 (product-boundary freeze; retained unedited) |
| [sc-m05-professional-widget-experience-plan-v2.md](sc-m05-professional-widget-experience-plan-v2.md) | SC-M05 (current; realises ADR-0016 — professional launcher morph, `widget_title` / `widget_greeting` / `widget_avatar_attachment_id` on the ADR-0015 Settings page, non-modal `role="dialog"`, `0.7.0` cache-bust bump; no schema/API/capability/Telegram/AI change) |
| ~~[sc-m06-support-availability-and-offline-tickets-plan-v1.md](sc-m06-support-availability-and-offline-tickets-plan-v1.md)~~ (superseded by v2) | SC-M06 (product-boundary stub; retained unedited) |
| [sc-m06-support-availability-and-offline-tickets-plan-v2.md](sc-m06-support-availability-and-offline-tickets-plan-v2.md) | SC-M06 (current; implementation-ready; realises [ADR-0017](../adr/0017-support-availability-authority-and-honest-offline-behaviour.md) — SC-owned schedule / date exceptions / manual override in the site timezone, precedence `override → exception → schedule → fail-safe unavailable`, honest offline widget copy, offline ticket = existing authenticated conversation committed atomically to `waiting_for_operator` via a new `new → waiting_for_operator` edge, Hub Waiting view, Diagnostics availability block, audit events; no Telegram mechanism, no AI, no schema / `db_version` / capability / Contract / Universal Telegram change) |
| [sc-ai1-operator-ai-drafts-approve-and-send-plan-v1.md](sc-ai1-operator-ai-drafts-approve-and-send-plan-v1.md) | SC-AI1 — **superseded by SC-M07** ([sc-m07-ai-first-visitor-support-plan-v1.md](sc-m07-ai-first-visitor-support-plan-v1.md)); product-boundary stub retained, not implemented |
| [sc-ai2-controlled-direct-ai-responses-plan-v1.md](sc-ai2-controlled-direct-ai-responses-plan-v1.md) | SC-AI2 — **superseded by SC-M07** ([sc-m07-ai-first-visitor-support-plan-v1.md](sc-m07-ai-first-visitor-support-plan-v1.md)); product-boundary stub retained, not implemented |
| [sc-m07-ai-first-visitor-support-plan-v1.md](sc-m07-ai-first-visitor-support-plan-v1.md) | SC-M07 (implementation-ready; realises [ADR-0018](../adr/0018-ai-first-visitor-support.md) — AI-first visitor support: an AI assistant is the first responder, the provider is never called in the visitor request (async WP-Cron worker does all provider I/O), AI answers are a new `ai` `ConversationMessage` direction structurally excluded from Telegram (R1), knowledge is bounded keyword retrieval over an administrator-approved encrypted allow-list — **not** "RAG"; vector/RAG stays SC-AI3, zero tools / no side effects, explicit human-handoff triggers, operator takeover via the existing claim primitives, OpenAI key `CredentialVault`-encrypted in an `autoload = false` option, disabled by default; `db_version` `12 → 13`, plugin `0.8.0 → 0.9.0` on implementation; no order/customer/WooCommerce integration, no Telegram/Contract change, no release/tag). **Supersedes SC-AI1 and SC-AI2.** ADR-0018 **Accepted** (`b47ce61` / PR #58); **implemented** — PR #59 squash-merged to `main` `a813900`, all CI green, `db_version` 13, version `0.9.0`; closure `docs/closure/sc-m07-ai-first-visitor-support-closure.md` (Closed, PASS WITH LIMITATIONS). Merged, not deployed |
