...
- [ADR-0015 — Operator-facing Support Chat Settings page, and separation of read-only Diagnostics](0015-operator-settings-page-and-diagnostics-separation.md) — Proposed
